...
uint8_t uart_rx(uint8_t uart, uint8_t *data, int8_t *capacity);
ISR(uart_rx_vect){
	volatile char c = UDR0; //Read the value out of the UART buffer
}
uart.Init(0,4800, true); //uart0: GPS
...
void parsedata() {
	 ...
	 * $GPGGA,hhmmss.ss,ddmm.mmmmm,N,dddmm.mmmmm,E,x,xx,x.xx,xxx.x,M,xx.x,M,,xxxx*hh
	 * ex: $GPGGA,092725.00,4717.11399,N,00833.91590,E,1,08,1.01,499.6,M,48.0,M,,0000*6A,
	 *
	 * WORDS:
